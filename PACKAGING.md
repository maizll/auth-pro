...
仓库根目录 `VERSION`（当前 `1.4.10`）是产品线默认版本：
...
./scripts/build-release.sh 1.4.10
```
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\scripts\build-release.ps1 -Version 1.4.10
```
