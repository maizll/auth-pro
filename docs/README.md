...
产品版本以仓库根目录 `VERSION` 为准，当前 **1.5.4**。下面的手册按当前代码编写。
...
| [商业版](commercial.md) | 免费版限制、升级、源站配置、图标与文字提醒、快照公钥发布步骤 |
| [安全说明](security.md) | 已做的加固，以及运维必须自己保管的密钥和备份 |
| [发布包目录](../PACKAGING.md) | `auth_pro-full-*.tar.gz` 解压后的文件布局 |
| [更新日志](../CHANGELOG.md) | 本产品各版本变更 |
| [发布说明](release-notes-1.5.4.txt) | 当前版本写入在线更新 `notes` 的文本；历史版本为同目录 `release-notes-*.txt` |
