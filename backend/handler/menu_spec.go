...
func productMenuSpecs() []productMenuSpec {
	...
	return []productMenuSpec{
		...
		{ID: 908, ParentName: "SourceStation", Name: "SourceStationEdition", Path: "edition", Component: "/source-station/edition", Title: "menus.sourceStation.edition", Icon: "ri:vip-crown-line", Sort: 8, KeepAlive: true, Roles: ops},
		{ID: 909, ParentName: "SourceStation", Name: "SourceStationStoreOrders", Path: "store-orders", Component: "/source-station/store-orders", Title: "menus.sourceStation.storeOrders", Icon: "ri:bill-line", Sort: 9, KeepAlive: true, Roles: ops},
		{ID: 910, ParentName: "SourceStation", Name: "SourceStationStoreLicenses", Path: "store-licenses", Component: "/source-station/store-licenses", Title: "menus.sourceStation.storeLicenses", Icon: "ri:key-2-line", Sort: 10, KeepAlive: true, Roles: ops},
		{ID: 911, ParentName: "SourceStation", Name: "SourceStationStoreRevenue", Path: "store-revenue", Component: "/source-station/store-revenue", Title: "menus.sourceStation.storeRevenue", Icon: "ri:money-cny-circle-line", Sort: 11, KeepAlive: true, Roles: ops},
...
func ensureProductMenus(db *sql.DB) {
	...
	// 当面付配置收口到「支付配置」，清掉已写入老库的平行菜单。
	removeAlipayF2FConfigMenu(db)
	_, _ = db.Exec(`
