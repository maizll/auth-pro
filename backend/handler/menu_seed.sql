...
(906, 9, 'SourceStationPlugins',      'plugins',      '',                             '/source-station/packages',                      'menus.sourceStation.plugins',      'ri:puzzle-line',        6, 1, 1),
(907, 9, 'SourceStationTemplates',    'templates',    '',                             '/source-station/packages?category=home-template', 'menus.sourceStation.templates',  'ri:layout-4-line',      7, 1, 1);
